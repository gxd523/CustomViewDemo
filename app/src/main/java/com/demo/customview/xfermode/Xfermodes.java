package com.demo.customview.xfermode;
...
public class Xfermodes extends Activity {
    ...
    static Bitmap makeDst(int w, int h) {
        ...
        new Canvas(bm).drawOval(new RectF(0, 0, w * 3 / 4, h * 3 / 4), p);
        return bm;
    }
    ...
    static Bitmap makeSrc(int w, int h) {
        ...
        new Canvas(bm).drawRect(w / 3, h / 3, w * 19 / 20, h * 19 / 20, p);
        return bm;
    }
    ...
    private static class SampleView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            for (int i = 0; i < sModes.length; i++) {
                ...
                // draw the label
                canvas.drawText(sLabels[i], x + W / 2, y - textPaint.getTextSize() / 2, textPaint);
                x += W + 10;
